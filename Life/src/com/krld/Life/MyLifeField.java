...
public class MyLifeField extends Actor {
    ...
    private static final int SUB_BUTTON_2_X = SUB_BUTTON_X + 50;
    ...
    private void createCells(float x, float y) {
        try {
            if (createType == 1) {                             //block
                ...
                field[((int) (x / SIZE)) + 10][((int) (y / SIZE))] = 1;
                field[((int) (x / SIZE)) + 10][((int) (y / SIZE)) + 1] = 1;
                field[((int) (x / SIZE)) + 10][((int) (y / SIZE)) - 1] = 1;
                field[((int) (x / SIZE)) + 11][((int) (y / SIZE)) - 2] = 1;
                field[((int) (x / SIZE)) + 11][((int) (y / SIZE)) + 2] = 1;

                field[((int) (x / SIZE)) + 12][((int) (y / SIZE)) - 3] = 1;
                field[((int) (x / SIZE)) + 12][((int) (y / SIZE)) + 3] = 1;

                field[((int) (x / SIZE)) + 13][((int) (y / SIZE)) - 3] = 1;
                field[((int) (x / SIZE)) + 13][((int) (y / SIZE)) + 3] = 1;

                field[((int) (x / SIZE)) + 14][((int) (y / SIZE))] = 1;

                field[((int) (x / SIZE)) + 15][((int) (y / SIZE)) - 2] = 1;
                field[((int) (x / SIZE)) + 15][((int) (y / SIZE)) + 2] = 1;

                field[((int) (x / SIZE)) + 16][((int) (y / SIZE)) - 1] = 1;
                field[((int) (x / SIZE)) + 16][((int) (y / SIZE)) + 1] = 1;
                field[((int) (x / SIZE)) + 16][((int) (y / SIZE))] = 1;
                field[((int) (x / SIZE)) + 17][((int) (y / SIZE))] = 1;

                field[((int) (x / SIZE)) + 20][((int) (y / SIZE)) + 1] = 1;
                field[((int) (x / SIZE)) + 20][((int) (y / SIZE)) + 2] = 1;
                field[((int) (x / SIZE)) + 20][((int) (y / SIZE)) + 3] = 1;

                field[((int) (x / SIZE)) + 21][((int) (y / SIZE)) + 1] = 1;
                field[((int) (x / SIZE)) + 21][((int) (y / SIZE)) + 2] = 1;
                field[((int) (x / SIZE)) + 21][((int) (y / SIZE)) + 3] = 1;

                field[((int) (x / SIZE)) + 22][((int) (y / SIZE)) + 4] = 1;
                field[((int) (x / SIZE)) + 22][((int) (y / SIZE))] = 1;

                field[((int) (x / SIZE)) + 24][((int) (y / SIZE))] = 1;
                field[((int) (x / SIZE)) + 24][((int) (y / SIZE)) - 1] = 1;

                field[((int) (x / SIZE)) + 24][((int) (y / SIZE)) + 4] = 1;
                field[((int) (x / SIZE)) + 24][((int) (y / SIZE)) + 5] = 1;

                field[((int) (x / SIZE)) + 34][((int) (y / SIZE)) + 2] = 1;
                field[((int) (x / SIZE)) + 34][((int) (y / SIZE)) + 3] = 1;
                field[((int) (x / SIZE)) + 35][((int) (y / SIZE)) + 2] = 1;
                field[((int) (x / SIZE)) + 35][((int) (y / SIZE)) + 3] = 1;

            }   else if (createType == 9) {       //  pulsar
                field[((int) (x / SIZE))][((int) (y / SIZE))] = 1;
    ...
    private void drawSeparateLines(SpriteBatch batch, float parentAlpha) {
        ...
        renderer.filledRect(SUB_BUTTON_2_X, 0, WIDTH_SEPARATE_LINE, HEIGHT_WINDOW);
